...
![RStudio layout](fig/06-fig1.png){alt="Decision chart for appropriate test to use with multiple groups. 
...
Superimposed on the plot are contour lines for the CookÕs distance (another 
